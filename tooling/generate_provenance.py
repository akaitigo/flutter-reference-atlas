...
ARTIFACTS = [
    ...
    ("evals/flutter-router.definitive-skill-eval.json", "skill-eval", "Apache-2.0", ["reference-atlas-core-v1", "flutter-sdk-3.47.1-macos-arm64"], "tooling/ci_supply_chain/core_v2_adapter.py"),
    ("evals/definitive-skill-router.json", "skill-eval", "Apache-2.0", ["reference-atlas-core-v1", "flutter-sdk-3.47.1-macos-arm64"], "tooling/ci_supply_chain/core_v2_adapter.py"),
    ...
    ("surface.inventory.yaml", "generated", "Apache-2.0", ["reference-atlas-core-v1", "flutter-sdk-3.47.1-macos-arm64", "flutter-engine-3.47.1-deps", "dart-sdk-3.13.1", "devtools-2.60.0"], "tooling/ci_supply_chain/core_v2_adapter.py"),
    ("verification.matrix.yaml", "generated", "Apache-2.0", ["reference-atlas-core-v1", "flutter-sdk-3.47.1-macos-arm64", "flutter-engine-3.47.1-deps", "dart-sdk-3.13.1", "devtools-2.60.0"], "tooling/ci_supply_chain/core_v2_adapter.py"),
    ("depth.parity.yaml", "generated", "Apache-2.0", ["reference-atlas-core-v1", "flutter-sdk-3.47.1-macos-arm64"], "tooling/ci_supply_chain/core_v2_adapter.py"),
    ("authority/FE_DEPTH_REFERENCE.json", "document", "Apache-2.0", ["reference-atlas-core-v1"], "fixed-copy-from-frontend-behavior-atlas-4a0b2df8"),
    ("definitive/core-v2-fe-depth-reference.lock.json", "document", "Apache-2.0", ["reference-atlas-core-v1"], "human-authored-reference-lock"),
    ("third_party/reference-snapshots/frontend-behavior-atlas/8a9e34a89a55cc53702032783c06ede7246a286f/SNAPSHOT.json", "document", "Apache-2.0", ["reference-atlas-core-v1"], "tooling/reference_snapshot/verify.py"),
    ("third_party/reference-snapshots/frontend-behavior-atlas/7175de4305afb308722d5b83475e91c18da64957/SNAPSHOT.json", "document", "Apache-2.0", ["reference-atlas-core-v1"], "tooling/reference_snapshot/verify.py"),
